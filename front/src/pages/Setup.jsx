  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <div className="hb-rise mb-8">
        <p className="text-[10px] font-mono font-bold uppercase tracking-[0.3em] text-red-400 mb-2">Étape 2 / 2 — Configuration</p>
      ...
      <div className="hb-rise grid grid-cols-3 gap-2 mb-6" style={{ animationDelay: '80ms' }}>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-sm p-3 text-center">
          <MemoryStick className="w-4 h-4 text-red-400 mx-auto mb-1" />
          <p className="font-mono text-xs font-bold">{(plan.ram / 1024).toFixed(0)} Go RAM</p>
        </div>
        <div className="bg-zinc-900 border border-zinc-800 rounded-sm p-3 text-center">
          <HardDrive className="w-4 h-4 text-red-400 mx-auto mb-1" />
      ...
      <div className="hb-rise space-y-5 mb-8" style={{ animationDelay: '160ms' }}>
        <div className="bg-zinc-900 border-2 border-zinc-800 rounded-sm p-5">
          ...
          <input
            ...
            disabled={submitting}
            className="w-full bg-zinc-950 border border-zinc-800 rounded py-3 px-4 focus:border-red-400 focus:outline-none focus:shadow-[0_0_0_3px_rgba(239,68,68,0.12)] font-bold text-sm transition-all disabled:opacity-60"
          />
        </div>
      </div>
